...
__DEFINE__(1644549073981, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1644549073982,"./event-store":1644549073983}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1644549073982, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1644549073983, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1644549073982,"./utils":1644549073984}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1644549073984, function(require, module, exports) {
...
return __REQUIRE__(1644549073981);
})()
